...
function main(params) {
  ...
  const rules = [
    ...
    "PROCESS-NAME,Arc,DIRECT",
    "PROCESS-NAME,Arc Helper,DIRECT",
    "DOMAIN-KEYWORD,natureselect,DIRECT",
    ...
    "GEOSITE,category-scholar-!cn,Global",
    "GEOSITE,biliintl,Global",
